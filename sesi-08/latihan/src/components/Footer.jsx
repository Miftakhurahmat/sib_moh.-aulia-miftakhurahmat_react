			...
			<div className="container mx-auto">
				<div className="flex flex-wrap text-start">
					<div className="w-full px-4	 mb-12 text-slate-300 font-medium md:w-1/3">
						<h2 className="font-bold text-4xl text-white">MIFTALENT</h2>
						<h3 className="font-bold text-2xl mb-2">Hubungi Kami</h3>
						<p>miftakhurahmat15@gmail.com</p>
						<p>Jl. Nusa Indah</p>
						<p>Kab. Tegal</p>
					</div>
				...
				<div className="w-full pt-10 border-t border-slate-700">
					...
					<p className="font-medium text-sm text-center text-slate-500 mb-14">Dibuat dengan <span className="text-pink-500">❤️</span>oleh <span className="text-primary">Moh. Aulia Miftakhurahmat</span> , menggunakan <span className="text-blue-400">TailwindCSS ReactJS</span></p>
				</div>
			</div>
		</footer>
	)
